...
declare const sendMessage: ({ userHuid, groupChatId, messageBody, messageMeta }: SendMessage) => Promise<import("@expressms/smartapp-bridge/build/main/types/eventEmitter").EmitterEventPayload> | undefined;
